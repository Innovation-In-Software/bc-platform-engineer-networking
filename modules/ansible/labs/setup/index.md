...
Add the following lines to the SSH configuration file, replacing `<IP of Tower server from the spreadsheet>` with the actual IP address of your Tower, and confirm `IdentifyFile` is pointing to the correct location.
