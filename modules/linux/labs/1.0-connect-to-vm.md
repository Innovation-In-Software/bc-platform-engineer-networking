...
2. In Visual Studio Code, click **Clone Repository** and paste `https://github.com/Innovation-In-Software/bc-platform-engineer-networking`
...
Host Linux
  ...
  IdentityFile ~/Documents/bc-platform-engineer-networking/modules/linux/labs/keys/lab.pem
  User ec2-user
```
